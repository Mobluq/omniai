...
export async function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#edf7f9] text-[#171314]">
      <header className="fixed inset-x-0 top-0 z-40 h-[66px] border-b border-[#c9d8dc] bg-white/95 backdrop-blur-xl">
        <div className="flex h-full items-center justify-between gap-4 px-4 lg:px-9">
          ...
          <div className="flex min-w-0 items-center justify-end gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="inline-flex h-10 w-10 rounded-xl border-[#c9d8dc] bg-white px-0 md:w-auto md:px-3"
            >
            ...
            <Button
              ...
              className="h-10 min-w-10 rounded-full bg-[#2a1f1e] px-0 text-xs font-semibold text-white hover:bg-[#241c1b] hover:text-white md:px-3"
            >
              <Link href="/account">
